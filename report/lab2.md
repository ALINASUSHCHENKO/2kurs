...
пользователя guest (используя учётную запись администратора), а так же зададим пароль.


![useradd guest и passwd guest](image/1.jpg)2{ #fig:001 width=100% height=100% }

2. Далее войдиём  в систему от имени пользователя guest.

![guest](image/2.jpg){ #fig:002 width=100% height=100% }

3. Определим директорию, в которой мы находимсяс помозью команды : pwd.

![pwd](image/3.jpg){ #fig:003 width=100% height=100% }

4. Затем уточним имя нашего пользователя командой whoami.

![whoami](image/4.jpg){ #fig:004 width=100% height=100% }

5. Уточним имя нашего пользователя, список групп к которому он принадлежит, куда входит пользователь с помощью команды id.

![id](image/5.jpg){ #fig:005 width=100% height=100% }

6. Запомним и сравним вывод id с выводом команды groups.

![groups](image/6.jpg){ #fig:006 width=100% height=100% }

7. Введём команду cat /etc/passwd.

![cat /etc/passwd](image/7.jpg){ #fig:007 width=100% height=100% }

8. После выполнения команды найдём в нём свою учётную запись, определим uid пользователя и gid пользователя. 
После чего сравним найденные значения с полученными в предыдущих пунктах.

![Поиск данных](image/8.jpg){ #fig:008 width=100% height=100% }
![Поиск uid и gid](image/9.jpg){ #fig:009 width=100% height=100% }

9. Определим существующие в системе директории командой:
ls -l /home/

![ls -l /home/](image/10.jpg){ #fig:010 width=100% height=100% }
...
![chmod 000 dir1](image/14.jpg){ #fig:013 width=100% height=100% }
